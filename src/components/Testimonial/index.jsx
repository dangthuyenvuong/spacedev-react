...
/**
 * B1: Cài đặt thư viện ngoài index.html
 * 
 * B2: Sử dụng useId hoặc useRef để lấy ra DOM HTML
 * 
 * B3: Gắn javascript vào Element vừa lấy
 */
    ...
    useEffect(() => {
        function testimonialSlider() {
            ...
            if ($(ref.current).length) {
                let $this = $(ref.current)
                let $carousel = $this.find(".images .list").flickity({
                    contain: true,
                    wrapAround: false,
                    freeScroll: false,
                    cellAlign: 'center',
                ...
                let $imgs = $this.find('.carousel-cell picture img');
